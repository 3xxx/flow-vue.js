...
<el-button-group >
  ...
  <!-- <el-button type="primary" icon="el-icon-delete" size="small">导出</el-button> -->
</el-button-group>
  <template>
  <el-table
    :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))" border style="width: 100%">
...
<el-dialog title="系统登录" :visible.sync="dialogFormVisible" center>
  ...
  <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
    <el-form-item label="名称" prop="typename">
      <el-input v-model.number="ruleForm2.typename" auto-complete="off" placeholder="账号"></el-input>
    </el-form-item>
...
<script type="text/javascript">
  ...
  //   props:['value'],
  //   template:`
  //     <i :value="isCollapse" @click="changeCollapse(isCollapse)"></i>
  //   `,
  //   methods: {
      
  //   }
  // });
  Vue.component('MineHeader',{
    props:{
  ...
  var app = new Vue({
      ...
      methods:{
        ...
        flowtypelist(){
          axios.get(`/v1/admin/flowtypelist`,{//2.get通过params选项
            params:{
                page:1
            }
          })
