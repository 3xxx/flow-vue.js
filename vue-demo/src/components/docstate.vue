<template>
  <div>
    ...
    <vxe-table ref="xTable" :data.sync="docstatedata.docstates" border style="width: 100%" stripe :edit-config="{trigger: 'click', mode: 'cell'}"
    ...
    <el-pagination background
      ...
      :total="docstatedata.total" style="float: right; margin:10px">
    </el-pagination>
    ...
    name: 'docstate',
      ...
      methods:{
        ...
        docstate(currentPage){
          axios({
            method: 'get',
            url: '/flowstatelist',//2.get通过params选项/api
            params:{
              page:currentPage,
              limit:this.pageSize
            }
