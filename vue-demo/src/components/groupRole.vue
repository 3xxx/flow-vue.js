  ...
  <div>
    <el-col :span="24" class="breadcrumb-container">
      <el-button-group style="float: left; margin:10px">
        <el-button type="primary" size="small" @click="addRow(grouproledata)">新增</el-button>
      ...
      methods:{
        ...
        handleSubmit(index, row) {
          console.log(row);
              axios({
                method: "POST",//请求方式
                url: "http://127.0.0.1:8081/v1/admin/flowgrouprole",//请求地址
                params:{
                  acid:row.AcId,
                  gid:row.GroupId,
                  roleid:row.RoleId,
        ...
        grouprole(currentPage){
          axios({
            method: 'get',
            url: 'http://127.0.0.1:8081/v1/admin/flowgrouprolelist',//2.get通过params选项
            params:{
              page:currentPage
            }
          })
